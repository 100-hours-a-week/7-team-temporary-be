...
public interface ImageApi {
    ...
    @ApiResponses({
        @ApiResponse(
                ...
                description = "발급 성공",
                content =
                        @Content(schema = @Schema(implementation = ImageUploadUrlResponse.class))),
        @ApiResponse(
                responseCode = "401",
    ...
    ResponseEntity<ServerResponse<ImageGetUrlResponse>> issueGetUrl(
            String imageKey, ImageType type);
}
