...
public record ReportMessageCreateResponse(
    ...
    public static ReportMessageCreateResponse of(Long inputMessageId, Long streamMessageId) {
        return new ReportMessageCreateResponse(inputMessageId, streamMessageId);
    }
}
