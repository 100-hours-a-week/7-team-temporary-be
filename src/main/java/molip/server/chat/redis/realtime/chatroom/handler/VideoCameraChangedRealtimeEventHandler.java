...
public class VideoCameraChangedRealtimeEventHandler implements ChatRoomRealtimeEventHandler {
    ...
    public void handle(ChatRoomRealtimeEnvelope envelope) {
        try {
            VideoCameraChangedResponse payload =
                    objectMapper.readValue(
                            envelope.payloadJson(), VideoCameraChangedResponse.class);
