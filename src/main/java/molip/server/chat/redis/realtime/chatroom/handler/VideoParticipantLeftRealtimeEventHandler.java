...
public class VideoParticipantLeftRealtimeEventHandler implements ChatRoomRealtimeEventHandler {

    private static final String EVENT_TYPE = "video.participant.left";
