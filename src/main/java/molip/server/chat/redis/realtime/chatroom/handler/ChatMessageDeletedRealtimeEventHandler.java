...
public class ChatMessageDeletedRealtimeEventHandler implements ChatRoomRealtimeEventHandler {

    private static final String EVENT_TYPE = "message.deleted";
    ...
    public void handle(ChatRoomRealtimeEnvelope envelope) {
        try {
            SocketMessageDeletedResponse payload =
                    objectMapper.readValue(
                            envelope.payloadJson(), SocketMessageDeletedResponse.class);
