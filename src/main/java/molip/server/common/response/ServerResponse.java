...
public record ServerResponse<T>(
  ...
  public static <T> ServerResponse<T> success(T data) {
    return new ServerResponse<>("SUCCESS", "SUCCESS", data);
  }
  ...
  public static <T> ServerResponse<T> error(ErrorCode errorCode, T data) {
    return new ServerResponse<>(errorCode.getStatusValue(), errorCode.getMessage(), data);
  }
}
